...
const LitereLicenta =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de licență', 'Program de studii Învățământ cu frecvență', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Limbă şi literatură	', 'Limba şi literatura română - Limba şi literatura engleză', '1','9'],
      ['Limbă şi literatură', 'Limba şi literatura engleză - Limba şi literatura franceză', '2','12'],
      ['Limbă şi literatură', 'Limba şi literatura franceză - Limba şi literatura română', '7','24'],
      ['Limbă şi literatură', 'Limba şi literatura română - Limba şi literatura franceză', '0','0'],
      ['Limbă şi literatură', 'Limba şi literatura engleză – Limba şi literatura română', '0','35'],
      ['Ştiințe ale comunicării', 'Comunicare şi relații publice', '1','28'],
      ['Ştiințe ale educației', 'Pedagogia învățământului primar şi preşcolar', '1','0'],
    ],
    ...
    return (
          ...
          <ScrollView >                
              <View>
                 <Image style={{width:'100%',height:75}}   source={require('../../../assets/img/LITERE-logo.png')} />  
              </View>
...
export default LitereLicenta


const styles = StyleSheet.create({
  container: { padding: 15, backgroundColor: '#882f81' },
