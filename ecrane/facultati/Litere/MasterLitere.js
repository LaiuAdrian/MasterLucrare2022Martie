...
const MasterLitere =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de master', 'Program de studiide master acreditat', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Filologie	', 'Cultură și literatură română - bhe', '0','64'],
      ['Filologie	', 'Limba engleză. Practici de comunicare (în limba engleză)', '0','59'],
      ['Filologie	', 'Limba franceză. Practici de comunicare (în limba franceză)', '4','65'],
      ['Ştiințe ale comunicării	', 'Comunicare în spațiul public', '0','32'],
      ['Ştiințe ale educației	', 'Strategii inovative în educație', '1','0'],
