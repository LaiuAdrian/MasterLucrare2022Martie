...
const LicentaSport =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de licență', 'Program de studii Învățământ cu frecvență', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Educație fizică şi sport', 'Educație fizică şi sportivă', '2','19'],
      ['Educație fizică şi sport', 'Educație fizică şi sportivă - IFR', '0','0'],
      ['Educație fizică şi sport', 'Sport şi performanță motrică', '2','25'],
      ['Kinetoterapie', 'Kinetoterapie şi motricitate specială', '0','0'],
      ['Kinetoterapie', 'Kinetoterapie şi motricitate specială - IFR', '0','1'],
      ['Psihologie', 'Terapie ocupațională	', '1','25'],
    ...
    return (
          ...
          <ScrollView >                
              <View>
                 <Image style={{width:'100%',height:85}}   source={require('../../../assets/img/Logo_FSMSS_Ro.png')} />  
              </View>
              ...
              <View style={{marginVertical:10,marginHorizontal:15}}>
                  ...
                  <View style={{marginHorizontal:10}}>
                     ...
                     <Text>
                             2.600 lei/an – pentru programele de studii care au și locuri bugetate (Matematică, Informatică, Biologie)
                     </Text>
                     <Text>
...
export default LicentaSport


const styles = StyleSheet.create({
  container: { padding: 15, backgroundColor: '#0090cc' },
