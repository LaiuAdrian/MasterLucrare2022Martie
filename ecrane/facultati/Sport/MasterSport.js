...
const MasterSport =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de master', 'Program de studiide master acreditat', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Terapie ocupațională', 'Activități motrice curriculare şi de timp liber', '0','21'],
      ['Terapie ocupațională', 'Biologie Kinetoterapia în educarea şi reeducarea funcțională', '2','1'],
      ['Terapie ocupațională', 'Performanță sportivă', '4','65'],
