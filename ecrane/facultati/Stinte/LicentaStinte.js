...
const LicentaStinte =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de licență', 'Program de studii Învățământ cu frecvență', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Matematică', 'Matematică', '5','31'],
      ['Informatică', 'Informatică', '2','12'],
      ['Informatică', 'Informatică - IFR', '2','61'],
      ['Biologie', 'Biologie', '8','8'],
