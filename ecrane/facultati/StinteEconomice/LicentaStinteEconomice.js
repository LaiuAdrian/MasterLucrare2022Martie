...
const LicentaStinteEconomice =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de licență', 'Program de studii Învățământ cu frecvență', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Administrarea afacerilor', 'Administrarea afacerilor', '2','54'],
      ['Contabilitate', 'Contabilitate şi informatică de gestiune', '2','160'],
      ['Contabilitate', 'Contabilitate şi informatică de gestiune - IFR - IFR', '0','60'],
      ['Marketing', 'Marketing', '3','72'],
      ['Marketing', 'Marketing - ID', '08','23'],
    ...
    return (
          ...
          <ScrollView >                
               <View>
                 <Image style={{width:'100%',height:100}}   source={require('../../../assets/img/FSEC-logo.png')} />  
               </View>
              ...
              <View style={{marginVertical:10,marginHorizontal:15}}>
                  ...
                  <View style={{marginHorizontal:10}}>
                     ...
                     <Text>
                            2.800 lei/an – pentru programele de studii care au și locuri bugetate
                     </Text>
                     <Text>
                            2.600 lei/an – Marketing (ID), Contabilitate și informatică de gestiune (IFR)
                     </Text>
                  </View>
              </View>
...
export default LicentaStinteEconomice;


const styles = StyleSheet.create({
  container: { padding: 15, backgroundColor: '#d5292c' },
