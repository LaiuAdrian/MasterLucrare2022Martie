...
const MasterStinteEconomice =({navigation})=>{

   const tabel = {
    tableHead: [ 'Domeniul de master', 'Program de studiide master acreditat', 'Locuri bugetate*','Locuri cu taxă'],
    // tableTitle: ['Title', 'Title2', 'Title3', 'Title4'],
    tableData: [
      ['Contabilitate	', 'Contabilitate, audit şi expertiză contabilă', '0','7'],
      ['Marketing	', 'Biologie medicală', '0','2'],
      ['Filologie	', 'Marketing şi comunicare în afaceri', '0','11'],
...
export default MasterStinteEconomice;
